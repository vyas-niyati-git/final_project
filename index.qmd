...
mmr_gdp_plot <- 
  ...
  labs(
    ...
    x = "GDP per Capita (log scale)",
    y = "Infant Mortality Rate (per 100,000 live births)"
  ) +
   theme_minimal() +
   theme(legend.position = "none")
...
- Countries with **lower GDP per capita** generally show **higher infant and maternal mortality rates**.

- *High-income countries* tend to cluster at the lower end of mortality rates.
